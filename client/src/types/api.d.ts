...
// ====================================================
// GraphQL mutation operation: ValidateEmailVerification
// ====================================================

export interface ValidateEmailVerification_ValidateEmailVerification {
	__typename: "ValidateEmailVerificationResponse";
	res: boolean;
	error: string | null;
}

export interface ValidateEmailVerification {
	ValidateEmailVerification: ValidateEmailVerification_ValidateEmailVerification;
}

export interface ValidateEmailVerificationVariables {
	key: string;
}
...
export interface GetRideByIdRide_GetRideById_ride {
	...
	distance: string | null;
	duration: string | null;
	driver: GetRideByIdRide_GetRideById_ride_driver | null;
	passenger: GetRideByIdRide_GetRideById_ride_passenger | null;
	chatId: number | null;
}
...
export interface GetRideHistoryVariables {
	isDriver: boolean;
	paging: number;
}
...
export interface EmailVerification_EmailVerification {
